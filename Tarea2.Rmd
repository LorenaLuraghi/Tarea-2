...
```{r}
gastos %>%  filter (Importe >2e+06)  %>% ggplot(aes(x =Importe,y=Prestacion,color=Edad_aÃ.os)) + geom_point() + labs(title="Prestaciones más costosas con sus respectivos rangos de edad", caption="El costo de los servicios no depende de la edad del paciente")
```
